...
пример: __git checkout__ *branch name*

## Просмотр списка веток, а также на какой ветке находится пользователь
**git branch**
## Удаление ветки 
**git branch -d** *branch name* - безопасное удаление
**git branch -D** *branch name* - с помощью этой команды возможно удаление ветки master 
