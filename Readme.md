...
Для работы с удалёнными репозиториями можно использовать несколько путей как через консоль версию так и напрямую с GITHub.

создаем новую ветку 
вносим измениея 
делаем коммит 
слияние через кнопку 
sycn fork - слить репозитории
