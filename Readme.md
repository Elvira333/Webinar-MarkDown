...
## Клонирование
Для того чтоб клонировать репозиторий из Github.com, достаточно ввести команду *git clone*, далее ввести ссылку на удалённый репозиторий
## Отправка изменений
Для того чтобы отправить изменения в удаленный репозиторий, вводится команда *git push*
## Получение изменений
Для того чтобы получить изменения из удаленного репозитория, вводится команда *git pull*
